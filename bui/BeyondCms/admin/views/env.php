...
<div class="detail-section">
    ...
    <div class="row detail-row">
        <div class="span24">
            ...
            function getStatus($status){
                global $res;
                return $status ? '<img src="'.$res.'/img/tick_circle.png" />' : '<img src="'.$res.'/img/cross_circle.png" />';
            }
            ?>
            <div id="grid">
                <div class="bui-simple-grid bui-simple-list bui-grid-border" style="width: 950px;" aria-disabled="false"
                    ...
                    <table cellspacing="0" cellpadding="0" class="bui-grid-table">
                        ...
                        <tr>
                            ...
                            <th width="100" class="bui-grid-hd ">
                                <div class="bui-grid-hd-inner">
                                    <span class="bui-grid-hd-title">配置值</span> ( <img src="<?=$PUBLIC?>/img/tick_circle.png" />说明该配置项为打开 <img src="<?=$PUBLIC?>/img/cross_circle.png" />说明该配置项关闭或未配置 )
                                </div>
                            </th>
                        </tr>
                        </thead>
    ...
    <div class="row detail-row">
        <div class="span24">
            <label>PHP常见组件支持检测：( <img src="<?=$PUBLIC?>/img/tick_circle.png" /> 说明该配置项为打开 <img src="<?=$PUBLIC?>/img/cross_circle.png" /> 说明该配置项关闭或未配置 )</label>
            <?php
            //转换函数 将布尔值转换成显示更友好的图形方式
