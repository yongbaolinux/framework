...
<link rel="stylesheet" type="text/css" href="<?=base_url();?>application_res/<?=$cfg['configSiteTemplate']?>/css/metinfo_ui.css" id="metuimodule" data-module="3">
...
<![endif]-->
<link href="<?=base_url();?>application_res/<?=$cfg['configSiteTemplate']?>/css/online.css" rel="stylesheet" type="text/css" id="onlinecss">
</head>
<body>
<header>
  <div class="inner">
    <div class="top-logo"> <a href="<?=base_url();?>" title="" id="web_logo"> <img src="<?=base_url();?>application_res/<?=$cfg['configSiteTemplate']?>/images/1342516579.png" alt="" title="" style="margin:20px 0px 0px 0px;"> </a>
...
<div class="sidebar inner">
  ...
  <div class="sb_box">
    <h3 class="title">
      <div class="position">当前位置：<a href="<?=base_url();?>" title="网站首页">网站首页</a> <?php if(is_array($position) && count($position) >0 ){ foreach($position as $value){ ?>&gt; <a href="<?=base_url();?>index.php?c=module&m=show&mid=<?=$value['id']?>"><?=$value['module_cname']?></a><?php }} ?></div>
      <span><?=$module['module_cname']?></span> </h3>
    <div class="clear"></div>
    <div class="active" id="productlist">
      <ul class="list-none metlist">
	<?php if(isset($singleData[0]['content'])){ ?>
		<div><?=$singleData[0]['content'];?></div>
	<?php } ?>
      </ul>
      <div class="clear"></div>
    </div>
