	...
	<div class="container" id="wrap">
        ...
        <div id="product-shows">
            ...
            <div id="product-show" class="clearfix">
            	<ul>
                	<li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品一</span></li>
                    <li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品二</span></li>
                    <li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品三</span></li>
                    <li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品四</span></li>
                    <li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品五</span></li>
                    <li><div><img src="<?=base_url()?>application_res/<?=$cfg['configSiteTemplate']?>/images/images/product.png" /></div><span>产品六</span></li>
                </ul>
            </div>
        </div>
        <!-- 产品展示分页 -->
