  ...
  static function start(){
    ...
    static function setExpire($time, $add = false)
    {
        if ($add) {
            ...
            $currentGcMaxLifetime = CI_Session2::setGcMaxLifetime(null);
            CI_Session2::setGcMaxLifetime($currentGcMaxLifetime + $time);
    ...
    static function _init()
    {
        ...
        if (is_null(CI_Session2::detectID())) {
            CI_Session2::id(uniqid(dechex(mt_rand())));
        }
        // 设置Session有效域名
        CI_Session2::setCookieDomain('localhost');
        //设置当前项目运行脚本作为Session本地名
        CI_Session2::localName('diskroom');
        CI_Session2::name();
        CI_Session2::path();
        CI_Session2::setCallback();
    }
    ...
    {
        return CI_Session2::path().'/sess_'.session_id();
    }
